...
abstract contract GaslessBasePaymaster is IGaslessPaymaster, Ownable {
     ...
     */
     ...
     function addAvailAddr(address addr) public {
         require(admin == msg.sender, "Verifying only admin can add available address.");
     ...
     function _requireCallFromAvailAddrs(address userOpCallAddr) internal view virtual {
         require(availAddrs[userOpCallAddr] == true, "Verifying call address from user operation.");
     }
