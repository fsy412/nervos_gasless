...
describe('#Mint', function () {
    ...
    before(async function () {
        ...
        const testTx = await erc20.populateTransaction.mint(signer.address, ethers.utils.parseEther('20000'))
    ...
    it('Mint', async () => {
        ...
        console.log('balance before', ethers.utils.formatEther(balance.toString()))
        ...
        console.log('balance after', ethers.utils.formatEther(balance.toString()))

        // expect(ethers.utils.parseEther('200000')).to.be.equal(balance)
    })
})